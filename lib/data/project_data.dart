...
final List<Project> projects = [
  Project(
    ...
    cardImageUrl: AppImage.driveDuoCoverImage,
    techStack: [
      'Flutter',
      'Dart',
      'Firebase Core',
  ...
  Project(
    ...
    cardImageUrl: AppImage.quizizCoverImage,
    techStack: [
      'Flutter',
      'Dart',
      'Firebase Core',
  ...
  Project(
    ...
    cardImageUrl: AppImage.taskManagerCoverImage,
    techStack: [
      'Flutter',
      'Dart',
      'GetX',
  ...
  Project(
    ...
    cardImageUrl: AppImage.projectsmateCoverImage,
    techStack: [
      'Flutter',
      'Dart',
      'Dio',
